  ...
  <section id="item" style="background-color: rgb(255, 255, 255); border-radius: 20px;" class="item my-3 " data-filter="item">
    <div class="container">
        <div class="row justify-content-center mt-5">
          <div class="col-md-6">
            <h1 class="text-center mb-4">Donasi</h1>
            <form id="donation-form" method="post" action="/donasi">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="amount" name="nominal" required>
              </div>
              <div class="mb-3">
                <label for="message" class="form-label">Pesan / Do'a</label>
                <input type="text" class="form-control" id="message" name="pesan">
              </div>
              {{-- <a href="#" id="pay-button" class="btn btn-success btn-lg">Pay Now</a> --}}
