    ...
    <div class="container-fluid" style="width: 100%;">
        <div class="container d-flex align-items-center justify-content-center shadow" style="background-image: linear-gradient(to bottom right, #2B7A77, #3AAFA9); height:75px; border-radius:750px; width: 97%; border: solid #ffffff 5px; margin: 0px; padding: 0px;">
            ...
            <div class="row">
                ...
                <div class="col mx-3">
                    <a href="" @auth data-bs-toggle="modal" data-bs-target="#profile" @else data-bs-toggle="modal" data-bs-target="#pesan" @endauth><img src="assets/img/ava-icon-white.png" alt="" style="height: 50px"></a>
                </div>
            </div>
...
@endauth
    ...
    <div class="container p-4">
      ...
      <div class="splide__track">
        <ul class="splide__list">
          ...
          <a href="campaign/{{ $item->id }}" class="splide__slide d-flex justify-content-center px-2 py-1" style="text-decoration: none; color:black">
  ...
  <section id="result" class="d-none" style=" background-color: rgb(255, 255, 255); border-radius: 20px;">
    ...
    <a href="campaign/{{ $item->id }}" class="item card hvr-grow m-2" data-filter="{{ $item->judul_campaign }}" style="width: 18rem; padding: 0px;  border-color: #2B7A77; text-decoration: none; color:black" >
      <img src="storage/{{ $item->foto_campaign }}" class="card-img-top" alt="...">
      <div class="card-body">
        <div class="card-title">
          <h5>{{ $item->judul_campaign }}</h5>
  ...
  <section id="category" class="d-none" style=" background-color: rgb(255, 255, 255); border-radius: 20px;">
    ...
    <div class="row justify-content-center p-4">
      @foreach($search as $item)
      <a href="campaign/{{ $item->id }}" class="item card hvr-grow m-2" data-filter="{{ $item->category_id }}" style="width: 18rem; padding: 0px;  border-color: #2B7A77; text-decoration: none; color:black">
        <img src="storage/{{ $item->foto_campaign }}" class="card-img-top" alt="...">
        <div class="card-body">
          <div class="card-title">
            <h5>{{ $item->judul_campaign }}</h5>
