    ...
    <form method="post" class="row g-3" action="/createCampaign"enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <select type="text" class="form-select" readonly aria-label="Default select example">
          ...
          <div class="col-md-6" hidden>
            ...
            <select name="nama_inisiator" type="text" class="form-select" readonly aria-label="Default select example" required>
