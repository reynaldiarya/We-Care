                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group mt-3">
                                <input required type="tel" class="form-control" name="phone_number"
                                    ...
                                    value="{{ old('phone_number', Auth::user()->phone_number) }}" data-parsley-type="number"
                ...
                <form class="form" method="POST" action="/password-update" data-parsley-validate>
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group mt-3">
                                <input type="password" class="form-control" name="password" placeholder="Password Sekarang"
