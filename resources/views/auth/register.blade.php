    ...
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <form method="POST" action="/register" data-parsley-validate>
                ...
                <div class="form-group position-relative has-icon-left mb-3">
                    <input required type="email" name="email" class="form-control form-control" placeholder="Email" data-parsley-type="email" data-parsley-error-message="Masukkan format email yang valid.">
                    <div class="form-control-icon">
                        <i class="bi bi-envelope"></i>
                    </div>
                </div>
                <div class="form-group position-relative has-icon-left mb-3">
                    <input type="tel" name="phone_number" class="form-control form-control" placeholder="Nomor Telepon" data-parsley-type="number" data-parsley-error-message="Masukkan format nomor telepon yang valid.">
                    <div class="form-control-icon">
                ...
                <div class="form-group position-relative has-icon-left mb-3">
                    <input required type="password" name="password_confirm" class="form-control form-control" placeholder="Konfirmasi Password" data-parsley-equalto="#password" data-parsley-error-message="Kata sandi tidak cocok.">
                    <div class="form-control-icon">
                        <i class="bi bi-shield-lock"></i>
                    </div>
                </div>
